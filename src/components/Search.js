    ...
    return (
        <div className="Search">
            ...
            {props.search.length > 0 && props.search.map((post) => (
                <div className="searchResult" onClick={() => props.handleDetail(true,post)}>
                    <div className="imgResult">
                        <img src="http://localhost:3000/pdfIcon.png"/>
                    </div>
                    <div className="desResult">
                        <small>{post.size}</small>
                        <small>{post.created_at}</small>
                        <small>{post.isi}</small>
                    </div>
                    <div className="resResult">
                        <div>
            ...
            :
                <div className="not-found">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-exclamation-square-fill" viewBox="0 0 16 16">
