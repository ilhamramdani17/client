...
const AddPost = (props) => {
    ...
    function handleImage (e) {
        ...
        setType(file.type)
        const fileType = ['application/pdf','image/jpg','image/jpeg','image/png','application/vnd.openxmlformats-officedocument.wordprocessingml.document']
        if (file) {
                ...
                <div className="addBody">
                    <form onSubmit={handleAddMeme}>
                        ...
                        <div className="addFile">
                                ...
                                :
                                <p>Tambahkan File Pdf, Docx atau Image </p>
                                }
                                <label htmlFor="file">
            ...
            <div className="reviewContainer">
                ...
                ?
                    ...
                    {type == "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
                        ?
                            <div className="viewDoc" style={{height: '95%',overflow: "hidden"}}>
                                 <FileViewer 
                                 fileType="docx"
                                 filePath={review}/>   
                            </div>
                        :
                            <div className="viewBody" style={{height: '95%',overflow: "hidden"}}>
                                <embed src={review + "#" + "toolbar=0"} type={type} width="100%" height="100%" />
                            </div>
                        }
                    </>
                : 
                    <div className="notRev">
